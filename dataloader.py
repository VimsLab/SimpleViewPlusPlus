...
# from scanobjectnn import ScanObjectNN as dgcnn_ScanObjectNN
...
#
# class ScanObjectNNDgcnn(Dataset):
#     def __init__(self, split, train_data_path,
#                  valid_data_path, test_data_path, num_points):
#         self.split = split
#         self.data_path = {
...
#             "data_path":  self.data_path
#         }
#         self.dataset = dgcnn_ScanObjectNN(**dgcnn_params)
#
#     def __len__(self):
#         return self.dataset.__len__()
#
...
def create_dataloader(split, cfg):
    ...
    # elif cfg.EXP.DATASET == "scanobjectnn_dgcnn":
    #     dataset_args.update(dict(**cfg.DATALOADER.SCANOBJECTNN_DGCNN))
    #     dataset = ScanObjectNNDgcnn(**dataset_args)
    else:
        assert False
