...
# SCANOBJECTNN_DGCNN
#-----------------------------------------------------------------------------
_C.DATALOADER.SCANOBJECTNN_DGCNN = CN()
_C.DATALOADER.SCANOBJECTNN_DGCNN.train_data_path = './training_data/h5_files/main_split/train_files.txt'
_C.DATALOADER.SCANOBJECTNN_DGCNN.valid_data_path = './training_data/h5_files/main_split/train_files.txt'
_C.DATALOADER.SCANOBJECTNN_DGCNN.test_data_path  = './training_data/h5_files/main_split/test_files.txt'
_C.DATALOADER.SCANOBJECTNN_DGCNN.num_points      = 1024
# ----------------------------------------------------------------------------
# MODEL
# -----------------------------------------------------------------------------
_C.MODEL = CN()
