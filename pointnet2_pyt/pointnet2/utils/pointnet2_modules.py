...
class _PointnetSAModuleBase(nn.Module):
    ...
    def forward(self, xyz, features=None):
        ...
        for i in range(len(self.groupers)):
            ...
            new_features_list2.append(new_features)
        ...
        return new_xyz,torch.cat(new_features_list2, dim=1),torch.cat(new_features_list, dim=1)#.view((-1, 256, 3))
    ...
    def __init__(self, npoint, radii, nsamples, mlps, bn=True, use_xyz=True):
        ...
        for i in range(len(radii)):
            ...
            self.groupers.append(
                pointnet2_utils.QueryAndGroup(self.npoint, radius, nsample, use_xyz=use_xyz)
