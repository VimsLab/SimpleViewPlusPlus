...
class BasicBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        # np.savez('out1_'+str(out.shape[1]), tensorname=out1)
        #print(out.shape)
        # exit()
        ...
        out = self.relu(out)
        #print(out.shape)
        # out2 = out.detach().cpu().numpy()
        # np.savez('out2_'+str(out.shape[1]), tensorname=out2)
        # print(out2.shape)
...
class Bottleneck(nn.Module):
    ...
    def forward(self, x):
        ...
        # dropped = d_new_points.detach().cpu().numpy()
        # np.savez('dropped', tensorname=dropped)
        # print(dropped.shape)
